...
//                     style={
//                       isWeekend 
//                         ? {backgroundColor: 'rgba(240, 115, 32, 0.6)', fontWeight: "bold", color: "white"} 
//                         : {backgroundColor: "#6A4923", color: "white", fontWeight: "bold"}
//                     }
//                   >
//                     {weekDay[dayOfWeek]}
//                   </StyledTableCell>
            ...
            <TableRow>
              {days.map(day => (
                <StyledTableCell 
                  key={day.getDate()} 
                  align="center"
                  style={{backgroundColor: "#6A4923", color: "white", fontWeight: "bold"}}
                >
                  {day.getDate()}
                </StyledTableCell>
              ))}
                ...
                {row.days.map((d, i) => {
                  ...
                  return (
                    <StyledTableCell 
                      key={i} 
                      align="center"
                      style={isWeekend ? {backgroundColor: 'rgba(253, 241, 203, 1)'} : {}}
                    >
                      {d.metrics.value}
                    </StyledTableCell>
                  );
